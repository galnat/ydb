...
def post(is_valid, error_description):
    ...
    status_to_header = {
        True: "Lalalal The validation of the Pull Request description is successful.",
        False: "Lalala The validation of the Pull Request description has failed. Please update the description."
    }
